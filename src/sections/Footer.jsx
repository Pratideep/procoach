...
const socials = [
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/pratideep__naik/',
    icon: (
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-12">
          ...
          <div className="max-w-xs">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-4 text-green-400 text-sm font-medium hover:text-green-300 transition-colors"
            >
          ...
          {/* Nav links */}
          <div>
            <p className="text-white/30 text-xs font-bold uppercase tracking-widest mb-4">Navigate</p>
          ...
          {/* Social links */}
          <div>
            <p className="text-white/30 text-xs font-bold uppercase tracking-widest mb-4">Follow</p>
            <div className="flex gap-3">
              {socials.map((s) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={s.name}
                  className="w-10 h-10 rounded-xl bg-dark-700 border border-white/8 flex items-center justify-center text-white/50 hover:text-brand-blue hover:border-brand-blue/30 transition-all duration-300 hover:scale-110"
                >
                  {s.icon}
                </a>
              ))}
