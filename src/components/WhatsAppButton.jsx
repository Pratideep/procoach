 ...
 * Includes a pulsing ring animation to draw attention.
 */
...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      {/* Button */}
      <span className="relative flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-[0_4px_24px_rgba(34,197,94,0.5)] transition-all duration-300 group-hover:scale-110">
